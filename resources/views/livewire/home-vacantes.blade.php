    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="p-6 bg-white divide-y divide-gray-200 rounded-lg shadow-sm">
                ...
                <div class="md:py-5 md:flex md:justify-between md:items-center">
                    <div class="grid grid-cols-2 md:flex-grow ">
                        <div class="md:flex-1">
                            <a
                                href="" class="text-3xl font-extrabold text-gray-600">
                                {{ $vacante->titulo }}
                            </a>
                        ...
                        <div class="flex-1 mt-auto ml-16">
                            <img src="{{ asset('storage/vacantes/' . $vacante->imagen) }}" alt="{{ 'Imagen vacante ' . $vacante->titulo}}" class="h-38 w-28">
                        </div>
                    </div>

                    <div class="mt-5 md:mt-0">
                        <a
                            class="block p-3 text-sm font-bold text-center text-white uppercase bg-indigo-500 border rounded-lg"
